...
export const klaviyoGetCatalogueItemsNock = (responseCode = 200, responseBody = {}) => {
    return nock('https://a.klaviyo.com:443', { encodedQueryParams: true })
        .get(
            `/api/catalog-items?filter=any%28ids%2C%5B%22%24custom%3A%3A%3A%24default%3A%3A%3Acb09966e-cb7a-4c3a-8eb5-e07f1a53ab8b%22%5D%29`,
        )
        .reply(responseCode, responseBody);
};

export const klaviyoGetCatalogueVariantsNock = (
    responseCode = 200,
    responseBody = {},
...
export const klaviyoCreateVariantNock = (body: any, responseCode = 200) => {
    return nock('https://a.klaviyo.com:443', { encodedQueryParams: true })
        .post(`/api/catalog-variants`, { data: body })
        .reply(responseCode);
};

export const klaviyoUpdateVariantNock = (id: string, body: any, responseCode = 200) => {
    return nock('https://a.klaviyo.com:443', { encodedQueryParams: true })
        .patch(`/api/catalog-variants/${id}`, { data: body })
        .reply(responseCode);
};

export const klaviyoDeleteVariantNock = (id: string, responseCode = 204) => {
    return nock('https://a.klaviyo.com:443', { encodedQueryParams: true })
        .delete(`/api/catalog-variants/${id}`, undefined)
        .reply(responseCode);
};
...
export const klaviyoGetCatalogueVariantsWithoutItemNock = (responseCode = 200, responseBody = {}) => {
    return nock('https://a.klaviyo.com:443', { encodedQueryParams: true })
        .get(
            `/api/catalog-variants?filter=any%28ids%2C%5B%22%24custom%3A%3A%3A%24default%3A%3A%3AA0E200000002E49%22%5D%29`,
        )
        .reply(responseCode, responseBody);
};
...
export const klaviyoUpdateItemNock = (id: string, body: any, responseCode = 200) => {
    return nock('https://a.klaviyo.com:443', { encodedQueryParams: true })
        .patch(`/api/catalog-items/${id}`, { data: body })
        .reply(responseCode);
};
